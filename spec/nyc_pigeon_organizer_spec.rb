    ...
    context 'Pigeons' do
      context 'Theo' do
        ...
        it 'knows Theo is purple and grey' do
          ...
          %w[purple grey].each { |c| expect(@theo[:color]).to include(c) }
        end
      ...
      context 'Peter Jr.' do
        ...
        it 'knows Peter Jr. is purple and grey' do
          ...
          %w[purple grey].each { |c| expect(@pete[:color]).to include(c) }
        end
      ...
      context 'Ms. K' do
        ...
        it 'knows Ms. K is grey and white' do
          ...
          %w[grey white].each { |c| expect(@ms_k[:color]).to include(c) }
        end
      ...
      context 'Queenie' do
        ...
        it 'knows Queenie is white and brown' do
          ...
          %w[white brown].each { |c| expect(@queenie[:color]).to include(c) }
        end
      ...
      context 'Alex' do
        ...
        it 'knows Alex is white and brown' do
          ...
          %w[white brown].each { |c| expect(@alex[:color]).to include(c) }
        end
